  ...
  <div class="container groupMaintain">
    <div v-if="!isEdit">
      <div class="actions_part clearfix">
        ...
        <el-input class="input_single w200 mr10 mb10" v-model="inputData" placeholder="产品季"></el-input> -->
        ...
        <el-tabs class="subnav_wrap">
          ...
          <div class="allparentlist">
            <ul
              ...
              <li class="w10p">
                <!-- <i type="primary" class="el-icon-document" title="查看" @click="editHandle()"></i> -->
