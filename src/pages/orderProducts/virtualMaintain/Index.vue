      ...
      <div class="base_wrap clearfix">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="200px" class="demo-ruleForm fl">
          <el-form-item label="产品编号">
            <el-input class="w300" v-model="ruleForm.name"></el-input>
          </el-form-item>
          ...
          <el-form-item label="产品分类">
            <el-select class="w300" v-model="ruleForm.region" placeholder="请选择产品分类">
              <el-option label="区域一" value="shanghai"></el-option>
              <el-option label="区域二" value="beijing"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="采购计量单位">
            <el-select class="w300" v-model="ruleForm.region" placeholder="请选择采购计量单位">
              <el-option label="区域一" value="shanghai"></el-option>
              <el-option label="区域二" value="beijing"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="上市日期" required>
            <el-col :span="11">
              <el-form-item prop="date1">
                <el-date-picker class="w300" type="date" placeholder="选择日期" v-model="ruleForm.date1" style="width: 100%;"></el-date-picker>
              </el-form-item>
            </el-col>
          </el-form-item>
          <el-form-item label="退市日期" required>
            <el-col :span="11">
              <el-form-item prop="date1">
                <el-date-picker class="w300" type="date" placeholder="选择日期" v-model="ruleForm.date1" style="width: 100%;"></el-date-picker>
              </el-form-item>
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="200px" class="demo-ruleForm fl">
          ...
          <el-form-item label="产品特性">
            <el-select class="w300" v-model="ruleForm.region" placeholder="请选择产品特性">
              <el-option label="区域一" value="shanghai"></el-option>
              <el-option label="区域二" value="beijing"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="推荐品">
            <el-checkbox class="w300" label="" name="type"></el-checkbox>
          </el-form-item>
          <el-form-item label="团购推荐指数">
            <el-rate class="w300" v-model="value1"></el-rate>
          </el-form-item>
          <el-form-item label="时尚度">
            <el-select class="w300" v-model="ruleForm.region" placeholder="请选择时尚度">
              <el-option label="区域一" value="shanghai"></el-option>
              <el-option label="区域二" value="beijing"></el-option>
            </el-select>
          </el-form-item>
